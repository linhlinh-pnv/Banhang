		  ...
		  <div id="content">															
		    <div class="row">															
		      <div class="col-sm-9">															
		        ...
		        <div class="row">															
		          <div class="col-sm-4">															
		            <img src="/sources/image/product/<?php echo e($sanpham->image); ?>" alt="">															
		          </div>															
		          <div class="col-sm-8">															
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HocPHPLa\Linh\resources\views/page/Detail.blade.php ENDPATH**/ ?>