  ...
  <table id="table_admin_product" class="table table-striped display">
    ...
    <tbody>
      ...
      <tr class="products-list-admin">
        ...
        <th><img src="sources/image/product/<?php echo e($product->image); ?>" alt="image" style="height: 100px;" /></th>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HocPHPLa\Linh\resources\views/pageadmin/admin.blade.php ENDPATH**/ ?>