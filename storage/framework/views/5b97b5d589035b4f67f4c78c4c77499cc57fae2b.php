				...
				<div class="row">
					...
					<div class="col-sm-9">
						...
						<br>
							...
							<h4 style="text-align:center;   font-weight: bold;"> <?php echo e($loai->name); ?></h4>
							<?php endif; ?>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img src="/sources/image/product/<?php echo e($sp->image); ?>" alt=""></a>
										</div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HocPHPLa\Linh\resources\views/page/loai_sanpham.blade.php ENDPATH**/ ?>