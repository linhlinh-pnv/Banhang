...
<div class="container beta-relative">
    ...
    <div class="container">
        <form action="admin-edit" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <img id="preview-image-before-upload" src="sources/image/product/<?php echo e($product->image); ?>" alt="preview image" style="max-height: 250px;">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HocPHPLa\Linh\resources\views/pageadmin/formEdit.blade.php ENDPATH**/ ?>